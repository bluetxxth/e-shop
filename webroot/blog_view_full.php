...
$test = '<input type="button" onclick="window.location.href="http://google.com"" >'	;			
...
$output = null;
  foreach($res as $key  => $c) {
	...
	$output .= " <div class = 'newsResult'><div class = 'title'><a href = 'blog_view.php?slug={$c -> slug}'>{$title}</a></div> <div class='updated'>{$updated}</div> <div class  ='user'><a href='user.php?id={$id}'> {$author}</a></div><div class = 'data'>{$data}</div> <div class = 'blogButton' ><a href='blog_edit_single.php?id={$c->id}'>Update</a></div> <div class = 'blogButton' ><a href='create.php?id={$c->id}'>Create</a> </div><div class = 'blogButton' ><a href='blog_edit_multi.php?id={$c->id}'>Edit all</a></div><div class = 'blogButton' ><a href='delete.php?id={$c->id}'>Delete </a></div></div> ";
